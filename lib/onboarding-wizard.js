...
export class OnboardingWizard {
  ...
  async setupEnvironment() {
    ...
    if (setupNow) {
      ...
      console.log('3. Running: source .env && claude');
    }
  }
...
`;
  ...
  async quickSetup(options = {}) {
    ...
    console.log('Run "source .env && claude" to start using MCP servers');
  }
}
